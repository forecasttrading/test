...
trace2 = go.Ohlc(x=resampled.index.to_pydatetime(),open=resampled.open,high=resampled.high,low=resampled.low,close=resampled.close)
...
py.offline.plot(fig,filename='tutorial_8.html')